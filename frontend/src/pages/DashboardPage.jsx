...
import { PawPrint, MessageCircle, ShoppingBag, Database, Plus, Sparkles, ArrowRight, Stethoscope, CalendarCheck } from 'lucide-react';
    ...
    <div className="dashboard">
      ...
      <div className="dashboard__custom-banner">
        ...
        <div className="dashboard__custom-banner-content">
          <h1>G<span className="paw-text">🐾</span>OD<br/>MORNING GUYS</h1>
